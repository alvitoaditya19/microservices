    ...
    <div className="flex justify-between items-center">
      <div className="w-1/2">
        <h1 className="text-5xl text-white mb-5">
          <span className="text-teal-400 font-semibold">The New</span> Way to{" "}
          <br />
          Achieve Good{" "}
        ...
        <form action={submit}>
          ...
          />
          <button
            className="bg-orange-500 hover:bg-orange-400 transition-all duration-200
      ...
      <div className="hidden w-1/2 md:flex justify-end pt-24 pr-16">
        <div className="relative" style={{ width: 369, height: 400 }}>
          ...
          <div className="absolute w-full h-full -mb-8 -ml-8">
            <img src="/images/img-hero-alysa.jpg" alt="hero with smile" />
          </div>
          <div
